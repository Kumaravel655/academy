...
export const courses: Course[] = [
  {
    ...
    longDescription:
      'Shine in the tech world with Python! This comprehensive course covers all the fundamentals including variables, functions, loops, and object-oriented programming. Designed at Sunshine Academy to help you build a bright future in programming.',
    instructor: 'Rajesh Kumar',
    instructorBio:
      'Rajesh is a senior software engineer with 10+ years of experience helping students succeed. A proud Sunshine Academy instructor dedicated to brightening minds.',
    ...
    testimonials: [
      {
        ...
        text: 'This course made learning Python incredibly easy. The instructor explains concepts so clearly!',
        rating: 5,
      ...
      },
      {
        ...
        name: 'Amit Verma',
        role: 'Data Analyst',
        text: 'Best Python course I have taken. Highly recommended for beginners.',
        rating: 4.5,
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'You just need Python (free) and a code editor. We recommend VS Code (also free).',
      },
      {
        id: 'faq3',
        question: 'Is there a certificate?',
        answer:
          'Yes, you get a completion certificate after finishing all modules and projects.',
      },
    ],
  ...
  },
  {
    ...
    longDescription:
      'Take your Java skills to the next level. Learn advanced concepts, design patterns, and build scalable applications. This course covers Spring Boot, microservices architecture, and best practices used in real-world enterprise applications.',
    instructor: 'Deepak Sinha',
    instructorBio:
      'Deepak is a Java architect with 15+ years of experience building enterprise applications at leading tech companies.',
    instructorImage: '/instructors/deepak.jpg',
    category: 'Java',
    level: 'Advanced',
    price: 6999,
    originalPrice: 12999,
    ...
    testimonials: [
      {
        ...
        text: 'This course elevated my Java skills to enterprise level. Deepak is an amazing instructor.',
        rating: 5,
      ...
      },
      {
        ...
        name: 'Sneha Gupta',
        role: 'Tech Lead',
        text: 'Comprehensive coverage of Spring Boot and microservices. Very practical and up-to-date.',
        rating: 4.8,
    ...
    faq: [
      {
        ...
        answer:
          'You should have solid understanding of Java basics and OOP concepts. Intermediate level Java knowledge is required.',
      },
      {
        id: 'faq2',
        question: 'Will I learn Docker?',
        answer:
          'Yes, we cover Docker for containerizing your applications and deploying to cloud platforms.',
      },
      {
        id: 'faq3',
        question: 'Are there real-world projects?',
        answer:
          'Absolutely! You will build 3 production-level projects during the course.',
      },
    ],
  ...
  },
  {
    ...
    longDescription:
      'Learn everything you need to become a full-stack web developer. Master React for frontend, Node.js for backend, and databases. Build complete web applications from concept to deployment.',
    instructor: 'Sarah Johnson',
    instructorBio:
      'Sarah is a full-stack developer and startup founder with 8+ years of web development experience.',
    ...
    testimonials: [
      {
        ...
        text: 'This full-stack course gave me everything I needed to land my first dev job!',
        rating: 5,
      ...
      },
      {
        ...
        text: 'Great progression from frontend to backend. Sarah explains everything perfectly.',
        rating: 4.6,
    ...
    faq: [
      {
        ...
        answer:
          'Basic programming knowledge is helpful but not required. We review fundamentals in the beginning.',
      },
      {
        id: 'faq2',
        question: 'What framework do we use?',
        answer:
          'We use React for frontend, Node.js with Express for backend, and MongoDB for databases.',
      },
      {
        id: 'faq3',
        question: 'Will I build real projects?',
        answer:
          'Yes, you will build 4-5 full-stack projects including a social media app and e-commerce platform.',
      },
    ],
  ...
  },
  {
    ...
    longDescription:
      'Learn data science fundamentals using Python. Work with pandas, NumPy, and Scikit-learn. Build machine learning models and create stunning data visualizations.',
    instructor: 'Dr. Arjun Mehta',
    instructorBio:
      'Dr. Mehta holds a PhD in Data Science and has worked at leading tech companies on ML projects.',
    instructorImage: '/instructors/arjun.jpg',
    ...
    testimonials: [
      {
        ...
        name: 'Neha Kapoor',
        role: 'Data Analyst',
        text: 'Comprehensive data science curriculum. Dr. Mehta makes complex concepts easy to understand.',
        rating: 5,
      ...
      },
      {
        ...
        name: 'Rohan Singh',
        role: 'ML Engineer',
        text: 'This course helped me transition from analyst to ML engineer. Highly valuable!',
        rating: 4.8,
    ...
    faq: [
      {
        id: 'faq1',
        question: 'Do I need statistics background?',
        answer:
          'Basic statistics knowledge is helpful. We cover necessary concepts during the course.',
      },
      {
        id: 'faq2',
        question: 'What datasets do we work with?',
        answer:
          'Real-world datasets from Kaggle and other sources. You work on multiple industry projects.',
      },
      {
        id: 'faq3',
        question: 'Can I use this to get a job?',
        answer:
          'Absolutely. You will have projects and certifications that employers look for in data science roles.',
      },
    ],
  ...
  },
  {
    ...
    longDescription:
      'Master React and Next.js to build fast, scalable web applications. Learn server-side rendering, static generation, and modern frontend architecture.',
    instructor: 'Alex Thompson',
    instructorBio:
      'Alex is a React specialist and open-source contributor with 9+ years of frontend development experience.',
    instructorImage: '/instructors/alex.jpg',
    category: 'Web Development',
    level: 'Intermediate',
    price: 5499,
    originalPrice: 10999,
    ...
    testimonials: [
      {
        ...
        name: 'Zara Khan',
        role: 'Frontend Developer',
        text: 'Best React course out there. The Next.js section completely changed my approach to web development.',
        rating: 5,
      ...
      },
      {
        ...
        text: 'Clear, concise, and practical. Exactly what I needed to master Next.js.',
        rating: 4.7,
    ...
    faq: [
      {
        id: 'faq1',
        question: 'Do I need React experience first?',
        answer: 'Yes, you should have intermediate React knowledge before taking this course.',
      },
      {
        id: 'faq2',
        question: 'What version of Next.js?',
        answer: 'We use the latest Next.js 14+ with app router and latest features.',
      },
      {
        id: 'faq3',
        question: 'Will we build production apps?',
        answer:
          'Yes, you will build 3 production-level Next.js applications during the course.',
      },
    ],
  ...
  },
  {
    ...
    longDescription:
      'Create beautiful, fast mobile applications for iOS and Android using Flutter. Learn Dart programming and build real-world apps with a single codebase.',
    instructor: 'Priya Chopra',
    instructorBio:
      'Priya is a mobile developer with 7+ years of experience building apps for startups and enterprises.',
    instructorImage: '/instructors/priya.jpg',
    ...
    testimonials: [
      {
        ...
        text: 'Flutter course was excellent. I built my first app in 4 weeks! Priya is a great mentor.',
        rating: 4.8,
      ...
      },
      {
        ...
        name: 'Lisa Chen',
        role: 'App Developer',
        text: 'Cross-platform development made easy. Highly recommended for anyone learning Flutter.',
        rating: 4.4,
    ...
    faq: [
      {
        id: 'faq1',
        question: 'Do I need mobile development experience?',
        answer: 'No, this course is beginner-friendly. Any programming background helps but is not required.',
      },
      {
        id: 'faq2',
        question: 'Can I deploy to app stores?',
        answer:
          'Yes, we cover the entire process of building and deploying to Google Play Store and Apple App Store.',
      },
      {
        id: 'faq3',
        question: 'Is Flutter suitable for startups?',
        answer:
          'Absolutely! Flutter is perfect for startups as it enables faster development and deployment.',
      },
    ],
...
export const instructors = [
  ...
  },
  {
    id: '2',
    name: 'Deepak Sinha',
    bio: 'Java architect with 15+ years in enterprise applications',
    image: '/instructors/deepak.jpg',
